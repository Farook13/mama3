...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5032034594', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002252567170', '0').split()]
